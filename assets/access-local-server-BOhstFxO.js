import{j as e,M as s}from"./index-DfGVomim.js";const r="_container_1ceg4_1",a="_content_1ceg4_13",i="_signature_1ceg4_70",n={container:r,content:a,signature:i},c=({children:o,date:t})=>e.jsx(e.Fragment,{children:e.jsx("div",{className:n.container,children:e.jsxs("div",{className:n.content,children:[o,e.jsx("br",{}),e.jsx("p",{className:n.signature,children:"Thanks for reading,"}),e.jsxs("p",{className:n.signature,children:["Tony Lam (",t,")"]})]})})}),l=`# How to Access Computer's Local Server on Any Device
...
`,d=()=>e.jsx(e.Fragment,{children:e.jsx(c,{date:"12/21/25",children:e.jsx(s,{children:l})})});export{d as default};
